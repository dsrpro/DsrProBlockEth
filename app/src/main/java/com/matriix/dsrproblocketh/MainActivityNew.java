...
public class MainActivityNew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (NetworkUtils.isNetworkAvailable(this)) {
            ...
            try {
                ...
                GetEthereumBalanceTasks task = new GetEthereumBalanceTasks(web3j, credentials);
                task.execute();
    ...
    class GetEthereumBalanceTasks extends AsyncTask<Void, Void, String> {

        private Web3j web3j;
        private Credentials credentials;

        public GetEthereumBalanceTasks(Web3j web3j, Credentials credentials) {
            this.web3j = web3j;
